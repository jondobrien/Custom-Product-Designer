...
class Aitoc_Aitcg_Model_Mysql4_Rewrite_Catalog_Product_Option extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Option
{
    ...
    protected function _getArrayOption($object)
    {
            $option = array(
                ...
                'text_angle' => $object->getTextAngle(),
                'text_font' => $object->getTextFont(),
                    );
            return $option;	
    }
    /**
    ...
    public function duplicate(Mage_Catalog_Model_Product_Option $object, $oldProductId, $newProductId)
    {
        ...
        foreach ($optionsCond as $oldOptionId => $newOptionId) {
            ...
            $sOptions = '`store_id`, `image_template_id`, `area_size_x`, `area_size_y`, `area_offset_x`, `area_offset_y`, `use_text`, `use_user_image`, `use_predefined_image`, `predefined_cats`,`use_masks`, `masks_cat_id`, `mask_location`, `allow_colorpick`,`text_length`,`allow_text_distortion`,`allow_predefined_colors`,`color_set_id`,`text_angle`,`text_font`';
