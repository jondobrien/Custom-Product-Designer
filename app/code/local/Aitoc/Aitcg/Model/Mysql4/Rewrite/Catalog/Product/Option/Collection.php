        ...
        $this->getSelect()
            ->joinLeft(array('default_option_aitimage'=>$this->getTable('catalog/product_option_aitimage')),
                ...
                array(
                   ...
                   # 'default_img_data'         => 'img_data',
                    'default_text_angle' => 'text_angle',
                    'default_text_font' => 'text_font',
                ))
            ->joinLeft(array('store_option_aitimage'=>$this->getTable('catalog/product_option_aitimage')),
                ...
                //'store_price'=>'price','store_price_type'=>'price_type',
                   ...
                   # 'default_img_data'         => 'img_data',
                    'store_text_angle' => 'text_angle',
                    'store_text_font' => 'text_font',
                ...
                //'price_type'=>new Zend_Db_Expr('IFNULL(`store_option_price`.price_type,`default_option_price`.price_type)')
                    'text_angle'          => new Zend_Db_Expr('IFNULL(`store_option_aitimage`.text_angle,`default_option_aitimage`.text_angle)'),
                    'text_font' => new Zend_Db_Expr('IFNULL(`store_option_aitimage`.text_font,`default_option_aitimage`.text_font)'),
                ));
        return $this;
    }
}