 ...
 */
var Aitcg_ImageSelector_Closed = new Class.create(
{
...
var Aitcg_ImageSelector_Opened = new Class.create( Aitcg_ImageSelector_Closed, 
{
    ...
    initialize : function( customImages, imageText ) {
        this.customImages = customImages;
        this.imageText    = imageText;
    },
    
    editor : function( option_id ) {
        if(typeof(this.areaEditors[option_id]) == 'undefined') {
            this.areaEditors[option_id] = new Aitcg_AreaEditor(option_id, this);
        }
        return this.areaEditors[option_id];
    },
    ...
    setOptionId : function ( option_id, image_template_id ) {
        ...
        if(option_id!= 0 && typeof( $('aitcg_option_text_font_'+option_id+'_tmp')) != 'undefined')
        {
            $('aitcg_option_text_font_'+option_id+'_tmp').setValue($('aitcg_option_text_font_'+option_id).getValue().split(','));
        }
    },
